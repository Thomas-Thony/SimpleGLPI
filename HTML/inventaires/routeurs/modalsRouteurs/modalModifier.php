        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="champModifs">
                    ...
                    <input type="text" name="nomMachine" id="nomMachine" placeholder="Nom de la machine" value="<?php echo $item['nomMateriel'] ?>" required>
                </div>
                ...
                <div class="champModifs">
                    ...
                    <input type="text" name="sousMasque" id="sousMasque" placeholder="xxx.xxx.xxx.xxx" value="<?php echo inet_ntop($item['sousMasque']) ?>" required>
                </div>
            </div>
