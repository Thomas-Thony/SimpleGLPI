...
$stmt = $connexion->prepare("SELECT * FROM inventaire JOIN typemateriel ON inventaire.idTypeMateriel = typemateriel.IdType  WHERE inventaire.idTypeMateriel IN (1, 2);");
$stmt->execute();
